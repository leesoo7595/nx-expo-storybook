...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/KX4VImuCoG)
...
```sh
npx nx serve nx-expo
```

To create a production bundle:

```sh
npx nx build nx-expo
```

To see all available targets to run for a project, run:

```sh
npx nx show project nx-expo
```
